...
const checks = [
 ...
 },
 {
  ...
  test(file, content) {
   ...
   return content.includes("includeLessons: true") || content.includes("includeLessons=1")
 ...
 },
 {
  ...
  test(file, content) {
   ...
   const suspicious = ["parsed.radicals", "json.radicals", "data.radicals"].filter((pattern) =>
...
const requiredFiles = ["src/features/hanzihome/hooks/useHanziHomeCourseLessons.ts"];
