...
begin
  ...
  v_seed_counts := pg_catalog.jsonb_build_object(
    'courses', pg_catalog.jsonb_array_length(coalesce(v_seed->'courses', '[]'::jsonb)),
    'books', pg_catalog.jsonb_array_length(coalesce(v_seed->'books', '[]'::jsonb)),
    'lessons', pg_catalog.jsonb_array_length(coalesce(v_seed->'lessons', '[]'::jsonb)),
    'lessonSections', pg_catalog.jsonb_array_length(coalesce(v_seed->'lessonSections', '[]'::jsonb)),
    'lessonTexts', pg_catalog.jsonb_array_length(coalesce(v_seed->'lessonTexts', '[]'::jsonb)),
    'vocabItems', pg_catalog.jsonb_array_length(coalesce(v_seed->'vocabItems', '[]'::jsonb)),
    'vocabExamples', pg_catalog.jsonb_array_length(coalesce(v_seed->'vocabExamples', '[]'::jsonb)),
    'vocabDetailSections', pg_catalog.jsonb_array_length(coalesce(v_seed->'vocabDetailSections', '[]'::jsonb)),
    'grammarPoints', pg_catalog.jsonb_array_length(coalesce(v_seed->'grammarPoints', '[]'::jsonb)),
    'grammarExamples', pg_catalog.jsonb_array_length(coalesce(v_seed->'grammarExamples', '[]'::jsonb)),
    'grammarDetailSections', pg_catalog.jsonb_array_length(coalesce(v_seed->'grammarDetailSections', '[]'::jsonb))
  );
  if v_seed_counts <> '{
    "courses": 1,
    "books": 4,
