...
| Notes               | open tabs, edit/save, reload, malformed persisted state                 | Lexical persistence-boundary regression test | storage, autosave callback integration, and browser persistence tests |
