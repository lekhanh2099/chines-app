...
function selectedPayload(resource: HumanitiesDocumentResource) {
 return resource.exerciseItems[0]?.payload;
}

function SourceReference({ resource }: { resource: HumanitiesDocumentResource }) {
...
function GlossaryCards({ resource }: { resource: HumanitiesDocumentResource }) {
 const t = useTranslations("Humanities.track");
...
function PoetryPoeticsLayer({ resource }: { resource: HumanitiesDocumentResource }) {
...
function ClaimsLayer({ resource }: { resource: HumanitiesDocumentResource }) {
...
function HistoryTimelineLayer({ resource }: { resource: HumanitiesDocumentResource }) {
...
function HistoryPerspectivesLayer({ resource }: { resource: HumanitiesDocumentResource }) {
...
function PracticeLayer({ resource }: { resource: HumanitiesDocumentResource }) {
...
export function HumanitiesTrackWorkspace({
 ...
 initialResource: HumanitiesDocumentResource | null;
}) {
 const t = useTranslations("Humanities.track");
