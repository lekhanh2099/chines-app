...
import { listDailyReadingEnrichmentJobs } from "@/features/daily-reading/daily-reading-enrichment-jobs.server";
   ...
   Response.json([
    {
     ...
     user_id: userId,
     article_id: "daily:2026-08-27:1234abcd",
  ...
  await expect(listDailyReadingEnrichmentJobs({ userId, runId })).resolves.toEqual([
   {
    ...
    articleId: "daily:2026-08-27:1234abcd",
