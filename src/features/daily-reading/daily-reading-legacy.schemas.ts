...
export const legacyDailyReadingSchema = z.strictObject({
...
export const legacyDailyReadingRunSchema = z.strictObject({
 id: nonEmptyTextSchema,
 date: z.iso.date(),
...
export const legacyDailyReadingSettingsSchema = z.strictObject({
 schemaVersion: z.literal("1.0.0"),
 autoGenerateEnabled: z.boolean(),
 preferredLevel: dailyReadingLevelSchema,
});

export const legacyDailyReadingLedgerSchema = z.strictObject({
 schemaVersion: z.literal("1.0.0"),
 items: z.array(legacyDailyReadingSchema).max(120),
 runs: z.array(legacyDailyReadingRunSchema).max(400),
});
...
export type LegacyDailyReading = z.output<typeof legacyDailyReadingSchema>;
export type LegacyDailyReadingRun = z.output<typeof legacyDailyReadingRunSchema>;
export type LegacyDailyReadingSettings = z.output<typeof legacyDailyReadingSettingsSchema>;
...
export const defaultLegacyDailyReadingSettings: LegacyDailyReadingSettings = {
 schemaVersion: "1.0.0",
