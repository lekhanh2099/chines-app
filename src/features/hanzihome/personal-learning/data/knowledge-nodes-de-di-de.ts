...
export const deDiDeNode = knowledgeNodeSchema.parse({
 ...
 diagnosticTasks: [
  {
   ...
   dimension: "M1",
   taskType: "choose",
   promptVi: "Chọn chữ de theo vai trò cấu trúc.",
  },
  {
   id: "de-m2",
   dimension: "M2",
   taskType: "explain",
   promptVi: "Chỉ ra từ chính, phần mô tả và phần bổ sung phía sau.",
  },
  {
   id: "de-m3",
   dimension: "M3",
   taskType: "transform",
   promptVi: "Biến cùng một ý thành định ngữ, trạng ngữ và bổ ngữ.",
  },
  {
   id: "de-m4",
   dimension: "M4",
   taskType: "timed",
   promptVi: "Sửa câu dài trong thời gian giới hạn.",
  },
  {
   id: "de-m5",
   dimension: "M5",
   taskType: "transfer",
   promptVi: "Dùng trong đoạn viết mới, không báo trước cấu trúc.",
  },
 ],
 opportunityRules: [
  {
   ...
   ruleVi: "Prompt khóa nghĩa ‘danh từ mà mệnh đề X xác định’.",
   humanReviewed: true,
   version: "1.0.0",
  },
  {
   ...
   ruleVi: "Trạng ngữ ngắn mà zero-marking hoàn toàn tự nhiên.",
   humanReviewed: true,
   version: "1.0.0",
  },
 ],
 claims: [
  {
   id: "de-c1",
   statementVi: "Phân biệt 的/地/得 dựa trên quan hệ cấu trúc, không phải ba bản dịch cố định.",
   sourceIds: ["research-pack-v1", "ross-2024", "yip-2016"],
   confidence: "high",
  },
  {
   id: "de-c2",
   statementVi: "Có trường hợp lược 地; phải xét độ dài, nhịp câu và tổ hợp thường dùng.",
   sourceIds: ["research-pack-v1", "bcc"],
   confidence: "medium",
  },
 ],
 sources: [
