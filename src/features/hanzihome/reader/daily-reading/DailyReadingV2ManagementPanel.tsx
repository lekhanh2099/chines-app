...
type DeleteTarget = { kind: "article"; article: DailyReadingV2 } | { kind: "all" } | null;
...
export function DailyReadingV2ManagementPanel() {
 ...
 function confirmDelete() {
  try {
   ...
   toast.error(error instanceof Error ? error.message : t("v2.management.toast.deleteFailed"));
  }
 }
