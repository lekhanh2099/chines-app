...
function preferredLengthScore(
 hanCharacters: number,
 preference: DailyReadingV2LengthPreference,
) {
...
export function assessDailyReadingSourceQuality(input: {
 ...
 const titleBodyCoverage = characterCoverage(
  input.metadataTitleZh,
  input.document.extractedTextZh,
 );
