...
function readingFixture() {
 return dailyReadingV2Schema.parse({
  schemaVersion: "2.0.0",
  id: "daily-v2:2026-08-19:abc12345",
  ...
  enrichment: {
   translation: {
    ...
    data: {
     ...
     adaptationNoticeVi: "",
     paragraphs: [
      { paragraphId: "source-p1", vi: "Những năm gần đây, ngày càng nhiều thành phố xây dựng không gian đọc công cộng.", roleVi: "" },
      { paragraphId: "source-p2", vi: "Các không gian này không chỉ có sách mà còn tổ chức tọa đàm và hoạt động văn hóa.", roleVi: "" },
      { paragraphId: "source-p3", vi: "Nhiều người dân xem đây là nơi mới để học tập và giao lưu hằng ngày.", roleVi: "" },
     ],
    },
   },
...
describe("Daily Reading V2 presentation model", () => {
 ...
 it("merges capture and enrichment history by the real attempt timestamp", () => {
  ...
  const capture = dailyReadingV2CaptureRunSchema.parse({
   id: "capture-1",
   date: "2026-08-19",
   kind: "manual",
   status: "succeeded",
