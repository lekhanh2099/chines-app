...
function learningStatusVariant(reading: DailyReadingV2): ComponentProps<typeof Badge>["variant"] {
...
export function DailyReadingV2View({ id, onBack }: { id: string; onBack(): void }) {
 ...
 const readerDocument = reading === null ? null : buildDailyReadingReaderDocument(reading);
