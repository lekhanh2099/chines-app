...
export function GrammarPracticeMini({ point }: { point: GrammarViewModel | null }) {
 ...
 return (
  <Card padding="md" className="rounded-xl">
   <div className="grid gap-2">
    ...
    <p className=" text-text-secondary">Đọc câu ví dụ và tự nói lại bằng cùng công thức.</p>
    <p className="rounded-xl bg-bg-subtle p-3 font-black text-text-primary">{example.zh}</p>
   </div>
  </Card>
 );
}
