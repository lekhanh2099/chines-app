...
export function VocabReviewPanel({
 ...
 if (session.items.length === 0) {
  return (
   <Card padding="lg" className="mx-auto max-w-3xl rounded-xl">
    <div className="grid gap-5 text-center">
     <ReviewHeader mode={mode} onModeChange={resetWithMode} />

     <div className="rounded-xl border border-dashed border-border-default bg-bg-subtle p-8">
 ...
 if (!item || session.state.completed) {
  return (
   <Card padding="lg" className="mx-auto max-w-3xl rounded-xl text-center">
 ...
 return (
  <Card padding="lg" className="mx-auto w-full max-w-4xl rounded-xl">
