...
export const memoryTipTypeSchema = z.enum(["grammar", "vocab", "formula", "custom"]);

export const memoryTipSourceTypeSchema = z.enum(["grammar", "vocab", "lesson", "custom", "system"]);
...
export const updateMemoryTipPayloadSchema = createMemoryTipPayloadSchema.partial().extend({
