...
async function parseApiError(response: Response) {
 ...
 return new MemoryTipsApiError(`Request failed with ${response.status}`, response.status);
}
...
export async function createMemoryTip(input: CreateMemoryTipPayload): Promise<MemoryTip> {
