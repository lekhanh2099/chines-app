...
export const currentApiInventory = [
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/learning-loop",
  methods: ["GET", "POST"],
  source: "route",
  group: "Học tập",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Reader learning-loop state is an authenticated HanziHome feature contract.",
 }),
 inventoryEntry({
 ...
 inventoryEntry({
  ...
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Daily Reading state is owned by the authenticated HanziHome reader.",
 }),
 inventoryEntry({
  currentPath: "/api/daily-reading/state",
  methods: ["GET", "PUT"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/annotations/[annotationId]",
  methods: ["DELETE", "PATCH"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Reader annotations are owned by the authenticated HanziHome reader.",
 }),
 inventoryEntry({
  currentPath: "/api/reading/annotations/[annotationId]",
  methods: ["DELETE", "PATCH"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/annotations",
  methods: ["GET", "POST"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/reading/annotations",
  methods: ["GET", "POST"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/data-quality",
  methods: ["GET"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Reader data-quality audit is an authenticated HanziHome maintenance surface.",
 }),
 inventoryEntry({
  currentPath: "/api/reading/data-quality",
  methods: ["GET"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/documents/[documentId]",
  methods: ["GET"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Reader content is served through the authenticated HanziHome reader boundary.",
 }),
 inventoryEntry({
  currentPath: "/api/reading/documents/[documentId]",
  methods: ["GET"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/documents",
  methods: ["GET"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Reader catalog is scoped to the authenticated HanziHome reader boundary.",
 }),
 inventoryEntry({
  currentPath: "/api/reading/documents",
  methods: ["GET"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/personal-state",
  methods: ["GET", "PUT"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Personal Learning state is owned by the authenticated HanziHome reader.",
 }),
 inventoryEntry({
  currentPath: "/api/personal-learning/state",
  methods: ["GET", "PUT"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/pdf-annotations",
  methods: ["GET", "PUT"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "PDF annotations are owned by the authenticated HanziHome reader.",
 }),
 inventoryEntry({
  currentPath: "/api/reading/pdf/annotations",
  methods: ["GET", "PUT"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/progress",
  methods: ["GET", "PUT"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Reader progress is owned by the authenticated HanziHome reader.",
 }),
 inventoryEntry({
  currentPath: "/api/reading/progress",
  methods: ["GET", "PUT"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/state",
  methods: ["GET"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Reader state bootstrap is owned by the authenticated HanziHome reader.",
 }),
 inventoryEntry({
  currentPath: "/api/reading/state",
  methods: ["GET"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/reader/pronunciation-overrides",
  methods: ["DELETE", "GET", "PUT"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Reader pronunciation overrides are owned by the authenticated HanziHome reader.",
 }),
 inventoryEntry({
  currentPath: "/api/reading/pronunciation-overrides",
  methods: ["DELETE", "GET", "PUT"],
  source: "route",
  group: "HanziHome đọc",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/hanzihome/practice/attempts",
  methods: ["GET", "POST"],
  source: "route",
  group: "Học tập",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "Practice attempts are owned by the authenticated HanziHome user.",
 }),
 inventoryEntry({
  currentPath: "/api/hanzihome/tts/library",
  methods: ["GET", "POST"],
  source: "route",
  group: "TTS",
  exposure: "internal-only",
  v1Path: null,
  internalReason: "TTS Studio library metadata is owned by the authenticated HanziHome user.",
 }),
 inventoryEntry({
 ...
 inventoryEntry({
  currentPath: "/api/ai/conversation",
  methods: ["POST"],
  source: "route",
  group: "AI",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/settings/ai-tasks",
  methods: ["GET", "PUT"],
  source: "route",
  group: "AI",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/daily-reading/enrichment-jobs",
  methods: ["GET", "POST", "DELETE"],
  source: "route",
  group: "AI",
  exposure: "internal-only",
 ...
 inventoryEntry({
  currentPath: "/api/daily-reading/enrichment-jobs/stream",
  methods: ["GET"],
  source: "route",
  group: "AI",
  exposure: "internal-only",
