  ...
  >
   <div className="flex min-w-0 items-start justify-between gap-3">
    <div className="min-w-0">
     <p className="text-xs font-black uppercase tracking-[0.2em] text-red-500">Từ vựng bài này</p>
     <h3 className="mt-2 break-words text-xl font-black text-stone-900">{workspace.lessonTitle}</h3>
    </div>
   ...
   <div className="mt-4 grid min-w-0 grid-cols-3 gap-2">
    ...
    <MiniStat label="Đã biết" value={workspace.summary.learnedCount} tone="green" />
    <MiniStat label="Còn yếu" value={workspace.summary.weakCount} tone="yellow" />
   </div>

   {!hasWords ? (
    <p className="mt-4 break-words rounded-2xlbg-stone-50 px-4 py-3  font-bold leading-6 text-stone-500">
     Chưa tìm thấy từ vựng khớp bài này. Có thể mở kho từ vựng để kiểm tra source/bài.
    </p>
   ) : null}
   ...
   <div className="mt-4 grid gap-2 sm:grid-cols-2 xl:grid-cols-1">
    <Link
     ...
     className="inline-flex h-11 min-w-0 items-center justify-center gap-2 rounded-2xlbg-red-500 px-4  font-black   shadow-theme-sm hover:bg-red-600"
    >
    ...
    <Link
     ...
     className="inline-flex h-11 min-w-0 items-center justify-center gap-2 rounded-2xl border-2 border-stone-200 bg-white px-4  font-black text-stone-700 shadow-theme-sm hover:bg-stone-50"
    >
