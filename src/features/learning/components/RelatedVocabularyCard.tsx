...
export function RelatedVocabularyCard({
 ...
 return (
  <aside className={cn("w-full max-w-full min-w-0 overflow-x-hidden rounded-[24px] border-2 border-stone-200 bg-white p-4 shadow-theme-sm", className)}>
   ...
   {!hasWords ? (
    <p className="mt-4 break-words rounded-2xl bg-stone-50 px-4 py-3 text-sm font-bold leading-6 text-stone-500">
   ...
   <div className="mt-4 grid gap-2 sm:grid-cols-2 xl:grid-cols-1">
    <Link
     ...
     className="inline-flex h-11 min-w-0 items-center justify-center gap-2 rounded-2xl bg-red-500 px-4 text-sm font-black text-white shadow-theme-sm hover:bg-red-600"
    >
